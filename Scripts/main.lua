...
local function LoadWebserver()
  local status, err = pcall(function()
    ...
    server.registerHandler("/players/*", "GET", playerManager.HandleGetSpecifcPlayerStates)

    -- Event management
    server.registerHandler("/events", "GET", eventManager.HandleGetAllEvents)
    server.registerHandler("/events", "POST", eventManager.HandleCreateNewEvent)
    server.registerHandler("/events/*", "GET", eventManager.HandleGetSpecificEvents)
